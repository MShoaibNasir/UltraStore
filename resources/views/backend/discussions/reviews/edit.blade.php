	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<span class="panel-title">{{ _lang('Update Product Review') }}</span>
			</div>
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="{{ action('ReviewsController@update', $id) }}" enctype="multipart/form-data">
					{{ csrf_field()}}
